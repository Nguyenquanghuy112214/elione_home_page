...
import { editPartner } from "@/actions/editPartner";
import { editExpert } from "@/actions/editExpert";

export const EditExpertModal = () => {
  ...
  const isModalOpen = isOpen && type === "editExpert";
