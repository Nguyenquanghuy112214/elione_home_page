...
import { deleteWhyChoose } from "@/actions/deleteWhyChoose";

export const DeleteWhyChooseModal = () => {
  const { isOpen, onClose, type, data } = useModalWhyChoose();
  const router = useRouter();

  const isModalOpen = isOpen && type === "deleteWhyChoose";
  const { id, title } = data;
