    ...
    >
      ...
      >
        <div className=" flex flex-col items-center justify-center gap-y-[2px]">
          <h1 className="sm:mb-2 md:mb-10 text_flip font-semibold bg-gradient-to-t from-text_banner from-20% via-white inline-block via-20% to-text_banner to-40% text-transparent sm:tracking-tighter bg-clip-text sm:text-[20px]  md:text-[40px] 2xl:text-[50px] md:tracking-tight">
            VỮNG NỀN TẢNG - SẴN SÀNG BỨT PHÁ
          </h1>
          <div className=" text-text_banner sm:text-base md:text-[20px] 2xl:text-[30px] tracking-tight">
            Trại hè Tiếng Anh dành cho học viên 5-10 tuổi
          </div>
          <div className="gradient_banner sm:p-2  md:p-3 uppercase rounded-xl mt-2 text-[#722814] font-medium sm:text-base md:text-[18px] shadow-lg 2xl:mt-4 2xl:text-[24px]">
            Khai Giảng 01/6 - 21/08/2024
          </div>
          <Separator className=" w-[40%] h-[2px] gradient_banner my-2 2xl:w-[45%]" />
          {/*  */}
          <div className=" text-text_banner uppercase mt-2 2xl:text-[20px]">
            Bắt đầu từ 01/4 - 30/05
          </div>
          <div className="2xl:text-[40px]  bg-gradient-to-t from-text_banner from-20% via-white inline-block via-20% to-text_banner to-40% text-transparent bg-clip-text  sm:text-[28px] md:text-[32px] font-medium">
            Đăng ký nhận ưu đãi
          </div>
          <div className=" text-text_banner sm:text-[18px] md:text-[22px] 2xl:text-[26px]">
            Tặng con mùa hè thật ý nghĩa
          </div>
          {/*  */}
          <div className=" bg-gradient-to-r from-[#f24522] from-0%  to-[#efc22d] to-80% px-2 py-1 mt-5 rounded-full text-white flex items-center min-w-[200px] h-[60px]">
