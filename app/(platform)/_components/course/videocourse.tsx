...
function VideoCourse({ item }: { item: Course }) {
  return (
    <Dialog>
      ...
      <div className=" px-4 py-2 border-[2px] border-solid border-[#ccc] shadow-md md:h-[220px] flex flex-col">
        <div className=" text-secondary mb-4 leading-5 font-semibold text-[15px]  line-clamp-3">
          {item?.title}
        </div>
        <div className="mt-auto">
          <div className=" flex items-center justify-start gap-x-1 text-black mt-auto">
            <Clock
