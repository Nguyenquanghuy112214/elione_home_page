  ...
  return (
    <Parallax speed={-50} >
      <motion.div
        ...
        className=" border-t-[6px] border-b-[6px] border-solid border-primary bg-banner3 bg-cover bg_10 bg-no-repeat sm:h-[460px] md:h-[550px] lg:h-[650px] xl:h-[700px] 2xl:h-[800px] "
      >
